...
public record ResolvePositionalMove(IKorssa<IRoveggi<uPositionalMove>> move) : Korvessa<IRoveggi<uPositionalMove>, ResolvedObj>(move)
{
    protected override RecursiveMetaDefinition<IRoveggi<uPositionalMove>, ResolvedObj> InternalDefinition() =>
        (_, iMove) =>
