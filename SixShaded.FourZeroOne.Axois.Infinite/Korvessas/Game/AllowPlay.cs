...
public record AllowPlay(IKorssa<IRoveggi<uPlayerIdentifier>> player) : Korvessa<IRoveggi<uPlayerIdentifier>, Actions>(player)
{
    protected override RecursiveMetaDefinition<IRoveggi<uPlayerIdentifier>, Actions> InternalDefinition() =>
        (_, iPlayer) =>
