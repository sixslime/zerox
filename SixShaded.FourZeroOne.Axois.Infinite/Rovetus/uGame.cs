...
public interface uGame : IRovetu
{
    ...
    public static readonly Rovu<uGame, IMulti<IRoveggi<Identifiers.uPlayerIdentifier>>> PLAYERS = new(Axoi.Du, "players");
    public static readonly Rovu<uGame, IMulti<IRoveggi<Identifiers.uUnitIdentifier>>> UNITS = new(Axoi.Du, "units");
}