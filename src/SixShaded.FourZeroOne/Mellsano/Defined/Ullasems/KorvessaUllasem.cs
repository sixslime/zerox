...
public record KorvessaUllasem<RVal> : KorvessaUllasem, IUllasem<IKorvessa<RVal>>
    where RVal : class, Rog
{
    public override bool MatchesKorssa(Kor korssa) => korssa is Korvessa<RVal> korvessa && korvessa.Du.Equals(Dusem);
}

public record KorvessaUllasem<RArg1, ROut> : KorvessaUllasem, IUllasem<IKorvessa<RArg1, ROut>>
...
public record KorvessaUllasem<RArg1, RArg2, ROut> : KorvessaUllasem, IUllasem<IKorvessa<RArg1, RArg2, ROut>>
    where RArg1 : class, Rog
...
public record KorvessaUllasem<RArg1, RArg2, RArg3, ROut> : KorvessaUllasem, IUllasem<IKorvessa<RArg1, RArg2, RArg3, ROut>>
    where RArg1 : class, Rog
    where RArg2 : class, Rog
