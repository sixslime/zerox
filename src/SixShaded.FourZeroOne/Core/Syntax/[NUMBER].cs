...
public static partial class KorssaSyntax
{
    ...
    public static Korvessa<Number, Number, Number> kClampMax(this IKorssa<Number> a, IKorssa<Number> b) => Korvessas.Min.Construct(a, b);
    public static Korvessa<Number, Number, Number> kClampMin(this IKorssa<Number> a, IKorssa<Number> b) => Korvessas.Max.Construct(a, b);
