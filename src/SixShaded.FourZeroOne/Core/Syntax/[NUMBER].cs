...
public static partial class KorssaSyntax
{
    ...
    public static Korvessa<Number, Number, Number> kMin(this IKorssa<Number> a, IKorssa<Number> b) => Korvessas.Min.Construct(a, b);
    public static Korvessa<Number, Number, Number> kMax(this IKorssa<Number> a, IKorssa<Number> b) => Korvessas.Max.Construct(a, b);
