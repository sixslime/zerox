    ...
    where R1 : class, Rog
{
    ...
    protected override ITask<IOption<MetaArgs<R1>>> Evaluate(IKorssaContext _, IOption<R1> in1) => new MetaArgs<R1> { Arg1 = in1 }.AsSome().ToCompletedITask();
    ...
    where R2 : class, Rog
{
    ...
    protected override ITask<IOption<MetaArgs<R1, R2>>> Evaluate(IKorssaContext _, IOption<R1> in1, IOption<R2> in2) => new MetaArgs<R1, R2> { Arg1 = in1, Arg2 = in2 }.AsSome().ToCompletedITask();
    ...
    where R3 : class, Rog
{
    ...
    protected override ITask<IOption<MetaArgs<R1, R2, R3>>> Evaluate(IKorssaContext _, IOption<R1> in1, IOption<R2> in2, IOption<R3> in3) => new MetaArgs<R1, R2, R3> { Arg1 = in1, Arg2 = in2, Arg3 = in3 }.AsSome().ToCompletedITask();
