    ...
    where R3 : class, Res
{
    ...
    protected override ITask<IOption<MetaArgs<R1, R2, R3>>> Evaluate(ITokenContext _, IOption<R1> in1, IOption<R2> in2, IOption<R3> in3) => new MetaArgs<R1, R2, R3> { Arg1 = in1, Arg2 = in2, Arg3 = in3 }.AsSome().ToCompletedITask();
