...
public sealed record With<C, R> : Token.Defined.StandardToken<ICompositionOf<C>>, IHasAttachedComponentIdentifier<C, ICompositionOf<C>> where R : class, Res where C : ICompositionType
{
