...
namespace SixShaded.FourZeroOne.Core.Syntax
{
    ...
    namespace Structure
    {
        namespace Token
        {
            ...
            public sealed record IfElse<R> where R : Res
            {
                public required IToken<R> Then { get; init; }
                public required IToken<R> Else { get; init; }
            }

            public sealed record SubEnvironment<R> where R : Res
            {
    ...
    {
        public static t.SubEnvironment<R> tSubEnvironment<R>(Structure.Token.SubEnvironment<R> block) where R : Res
        ...
        public static t.Fixed<r.Boxed.MetaFunction<ROut>> tMetaFunction<ROut>(Func<IToken<ROut>> tokenFunction) where ROut : Res
        {
        ...
        public static t.Fixed<r.Boxed.MetaFunction<ROut>> tMetaRecursiveFunction<ROut>(Func<DynamicAddress<r.Boxed.MetaFunction<ROut>>, IToken<ROut>> tokenFunction) where ROut : Res
        {
            var vs = new DynamicAddress<r.Boxed.MetaFunction<ROut>>();
        ...
        public static t.Multi.Union<R> tMultiOf<R>(List<IToken<R>> t) where R : Res
        { return new(t.Map(x => x.tYield())); }
        public static t.Multi.Union<R> tUnionOf<R>(List<IToken<IMulti<R>>> sets) where R : Res
        { return new(sets); }
        public static t.Multi.Intersection<R> tIntersectionOf<R>(List<IToken<IMulti<R>>> sets) where R : Res
        { return new(sets); }
        public static t.Nolla<R> tNollaFor<R>() where R : Res
        { return new(); }
    ...
    {
        public static t.IO.Select.One<R> tIOSelectOne<R>(this IToken<IMulti<R>> source) where R : Res
        { return new(source); }
        public static t.IO.Select.Multiple<R> tIOSelectMany<R>(this IToken<IMulti<R>> source, IToken<ro.Number> count) where R : Res
        { return new(source, count); }

        public static t.Execute<R> tExecute<R>(this IToken<r.Boxed.MetaFunction<R>> source) where R : Res
        { return new(source); }
        ...
        public static t.Fixed<r.Boxed.MetaFunction<ROut>> tMetaBoxed<ROut>(this IToken<ROut> token) where ROut : Res
        {
        ...
        public static t.DynamicAssign<R> tAsVariable<R>(this IToken<R> token, out DynamicAddress<R> ident) where R : Res
        {
            ident = new();
            return new(ident, token);
        }

        public static t.IfElse<R> tIfTrueDirect<R>(this IToken<ro.Bool> condition, Structure.Token.IfElse<r.Boxed.MetaFunction<R>> block) where R : Res
        { return new(condition, block.Then, block.Else); }
        public static t.Execute<R> t_IfTrue<R>(this IToken<ro.Bool> condition, Structure.Token.IfElse<R> block) where R : Res
        {
        ...
        public static t.Multi.Exclusion<R> tWithout<R>(this IToken<IMulti<R>> source, IToken<IMulti<R>> exclude) where R : Res
        { return new(source, exclude); }
        public static t.Multi.Count tCount(this IToken<IMulti<Res>> source)
        { return new(source); }
        public static t.Multi.Yield<R> tYield<R>(this IToken<R> token) where R : Res
        { return new(token); }
        public static t.Multi.Union<R> tToMulti<R>(this IEnumerable<IToken<R>> t) where R : Res
        { return new(t.Map(x => x.tYield())); }
        public static t.Multi.Union<R> tUnion<R>(this IToken<IMulti<R>> left, IToken<IMulti<R>> right) where R : Res
        { return new([left, right]); }
        public static t.Multi.Union<R> tFlatten<R>(this IEnumerable<IToken<IMulti<R>>> t) where R : Res
        { return new(t); }
        public static t.Multi.Contains<R> tContains<R>(this IToken<IMulti<R>> from, IToken<R> element) where R : Res
        { return new(from, element); }
        public static t.Multi.GetIndex<R> tAtIndex<R>(this IToken<IMulti<R>> token, IToken<ro.Number> index) where R : Res
        ...
        public static t.Component.Without<H> tWithoutComponent<H>(this IToken<ICompositionOf<H>> holder, Resolution.Unsafe.IComponentIdentifier<H> componentIdentifier)
            where H : ICompositionType
        { return new(holder) { ComponentIdentifier = componentIdentifier }; }
        public static Macro<ICompositionOf<D>, R> tDecompose<D, R>(this IToken<ICompositionOf<D>> composition) where D : IDecomposableType<D, R>, new() where R : Res
        ...
        public static t.DynamicReference<R> tRef<R>(this IMemoryAddress<R> ident) where R : Res
        { return new(ident); }
        ...
        { return new(value); }
        public static t.Fixed<R> tFixed<R>(this R value) where R : Res
        { return new(value); }
        public static t.Fixed<r.Multi<R>> tFixed<R>(this IEnumerable<R> values) where R : Res
        { return new(new() { Values = values.ToPSequence() }); }

        public static t.Fixed<r.Multi<R>> t_ToConstMulti<R>(this IEnumerable<t.Fixed<R>> values) where R : Res
