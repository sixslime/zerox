...
public record CheckWin(IKorssa<IRoveggi<uPlayerIdentifier>> player) : Korvessa<IRoveggi<uPlayerIdentifier>, IRoveggi<uWinChecks>>(player)
{
    protected override RecursiveMetaDefinition<IRoveggi<uPlayerIdentifier>, IRoveggi<uWinChecks>> InternalDefinition() =>
        (_, iPlayer) =>
