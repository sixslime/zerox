...
{
    public static new readonly Rovu<uUnsourcedAbility, IRoveggi<Types.uUnsourcedType>> TYPE = new("type");
    public static readonly Rovu<uUnsourcedAbility, MetaFunction<Rog>> ACTION = new("action");
