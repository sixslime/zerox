...
public class StandardCoreKey : ILanguageKey
{
    ...
    public IOption<Translation> TranslateKorssa(KorssaTranslationContext context, TranslationBuilder builder)
    {
        ...
        return typeMatch switch
        {
            ...
            Ct.Korvessa.Number.Max => __Translation(1, ", at least ", 1),
            Ct.Korvessa.Number.Min => __Translation(1, ", at most ", 1),
            Ct.Korvessa.Number.Clamp => __Translation(1, ", bounded by ", 1, "..", 1),
            Ct.Korssa.MetaExecuted => __Translation(1, " (meta executed)"),
