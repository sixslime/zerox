...
namespace FourZeroOne
{
    ...
    {
        public IEnumerable<ITiple<Resolution.Unsafe.IStateAddress, ResObj>> Objects { get; }
        ...
        public IState WithObjects<R>(IEnumerable<ITiple<Resolution.IStateAddress<R>, R>> insertions) where R : class, ResObj;
        public IState WithObjectsUnsafe(IEnumerable<ITiple<Resolution.Unsafe.IStateAddress, ResObj>> insertions);
    ...
    {
        public abstract IEnumerable<ITiple<IStateAddress, ResObj>> Objects { get; }
        ...
        public abstract IState WithObjectsUnsafe(IEnumerable<ITiple<IStateAddress, ResObj>> insertions);
        ...
        IState IState.WithObjects<R>(IEnumerable<ITiple<IStateAddress<R>, R>> insertions) => WithObjectsUnsafe(insertions);
    }
